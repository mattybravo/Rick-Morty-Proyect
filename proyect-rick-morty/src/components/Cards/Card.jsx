...
return(
<>
<div className="tarjeta border border-1 rounded border-dark d-flex justify-content-between aling-items-center">
    
 <div className="div-tarjeta d-flex flex-column justify-content-between aling-items-center"><img src={personaje.image}/>   
 ...
 { ocultar?"":
 <div className="tarjeta-oculta d-flex flex-column aling-items-center container justify-content-between">
